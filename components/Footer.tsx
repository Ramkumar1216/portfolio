      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-xl font-bold mb-4">Ramkumar</h3>
            <p className="text-gray-400 leading-relaxed">
              Data Analyst, Web Developer & Digital Marketer helping businesses grow with technology and insights.
            </p>
          </motion.div>
        ...
        >
          <p>&copy; 2024 Ramkumar. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
